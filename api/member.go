...
func (c *Client) AddMember(guildID, userID discord.Snowflake, data AddMemberData) (*discord.Member, error) {
	var member *discord.Member
	return member, c.RequestJSON(
		&member, "PUT",
