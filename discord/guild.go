...
type Member struct {
	...
	// Deafened specifies whether the user is deafened in voice channels.
	Deafened bool `json:"deaf"`
	// Muted specifies whether the user is muted in voice channels.
	Muted bool `json:"mute"`
	// GuildID specifies the guild the member is from.
	GuildID Snowflake `json:"guild_id"`
}
